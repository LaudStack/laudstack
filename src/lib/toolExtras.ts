...
function generateDefaultExtras(_toolName: string, _pricingModel: string): Omit<ToolExtras, 'screenshots'> {
  // Return empty arrays — tools without curated data should show empty states
  // rather than fabricated features and pricing that could mislead users.
