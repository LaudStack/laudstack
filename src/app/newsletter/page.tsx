...
const BENEFITS = [
  ...
  },
  {
    ...
    desc: 'Top reviews, founder stories, and community picks — curated signal from the LaudStack community.',
  },
];
...
const SOCIAL_PROOF: { name: string; role: string; quote: string }[] = [];
    ...
    <div className="min-h-screen bg-white text-slate-900 flex flex-col">
      ...
      <div className="flex-1">
        ...
        breadcrumbs={[{ label: 'Newsletter' }]}
          ...
          subtitle="Weekly digest: rising stacks, editor picks, and community insights."
          accent="amber"
          layout="centered"
          size="md"
        />
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-white bg-white border border-slate-200 rounded-xl text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:border-amber-400 transition-colors"
                />
              </div>
              <button
                type="submit"
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-16 space-y-20">
          ...
          <section className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { value: 'Growing', label: 'Subscriber base', icon: <Users className="w-5 h-5 text-amber-500" /> },
          ...
          <section>
            <div className="text-center mb-10">
              ...
              <h2 className="text-2xl sm:text-3xl font-black text-slate-900">Every edition includes</h2>
            </div>
            <div className="grid md:grid-cols-2 gap-6">
              {BENEFITS.map(b => (
                <div key={b.title} className="bg-slate-50 border border-slate-200 rounded-2xl p-6 hover:border-amber-300 transition-colors">
          ...
          <section>
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-black text-slate-900">This week's rising picks</h2>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                ...
                {SAMPLE_DIGEST.map(tool => (
                  <div key={tool.name} className="flex items-start gap-4 p-4 bg-slate-50 rounded-xl border border-slate-200">
          ...
          {/* Testimonials — shown only when real testimonials exist */}
          {SOCIAL_PROOF.length > 0 && (
            <section>
              <div className="text-center mb-8">
                <h2 className="text-2xl sm:text-3xl font-black text-slate-900">What readers say</h2>
              </div>
          ...
          <section className="bg-amber-50 border border-amber-200 rounded-2xl p-10 text-center">
            ...
            <h3 className="text-2xl font-black text-slate-900 mb-3">Join the LaudStack community</h3>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              <input
                ...
                className="flex-1 border border-slate-200 rounded-xl px-4 py-3 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:border-amber-400 transition-colors"
              />
              <button
                type="submit"
                disabled={subscribe.isPending}
