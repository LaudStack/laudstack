...
export default function Discussions() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <PageHero
        breadcrumbs={[{ label: 'Discussions' }]}
        eyebrow="Coming Soon"
        title="Community Discussions"
        subtitle="Share insights and connect with the LaudStack community."
        accent="amber"
        layout="centered"
        size="md"
      />
        ...
        <div className="max-w-lg w-full text-center">
          ...
          <form onSubmit={handleNotify} className="flex gap-2 max-w-md mx-auto mb-6">
            <input
              ...
              className="flex-1 px-4 py-3 rounded-xl bg-white border border-slate-200 text-sm text-slate-900 placeholder:text-slate-500 outline-none focus:border-amber-500 transition-colors"
            />
            <button
              type="submit"
          ...
          <div className="mt-10 pt-8 border-t border-slate-200">
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              <a href="/community-voting" className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg border border-slate-200 bg-white text-sm font-semibold text-slate-600 hover:border-amber-500 hover:text-amber-700 transition-all">
                Community Voting <ArrowRight className="w-3 h-3" />
              </a>
              <a href="/community-picks" className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg border border-slate-200 bg-white text-sm font-semibold text-slate-600 hover:border-amber-500 hover:text-amber-700 transition-all">
                Community Picks <ArrowRight className="w-3 h-3" />
              </a>
              <a href="/trending" className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg border border-slate-200 bg-white text-sm font-semibold text-slate-600 hover:border-amber-500 hover:text-amber-700 transition-all">
