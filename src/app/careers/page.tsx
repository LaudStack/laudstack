...
const OPEN_ROLES: Job[] = [
  {
    ...
    remote: true,
    level: 'Senior',
    description: 'Own and evolve core platform features — from the product discovery engine to the review system. You\'ll work across the full stack (TypeScript, React, Node.js, PostgreSQL) and have a direct impact on how professionals discover their next stack.',
    requirements: [
    ...
    <div className="min-h-screen bg-white text-slate-900 flex flex-col">
      ...
      <div className="flex-1">
        ...
        breadcrumbs={[{ label: 'Careers' }]}
          ...
          subtitle="A fully remote team making software discovery honest and community-driven."
          accent="amber"
          layout="centered"
          size="md"
        />
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-16 space-y-20">
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-5">
              {VALUES.map(v => (
                <div key={v.title} className="bg-slate-50 border border-slate-200 rounded-2xl p-6 flex gap-4">
          ...
          <section>
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4">
              {PERKS.map(perk => (
                <div key={perk.title} className="bg-slate-50 border border-slate-200 rounded-2xl p-5">
            ...
            <div className="space-y-3">
              {filteredJobs.map(job => {
                ...
                return (
                  <div
                    key={job.id}
                    className="bg-slate-50 border border-slate-200 rounded-2xl overflow-hidden hover:border-amber-300 transition-colors"
                  >
                    {/* Card header — always visible */}
                    <button
                      className="w-full text-left px-4 sm:px-6 py-5 flex items-start gap-4"
                    ...
                    {/* Expanded details */}
                    {isExpanded && (
                      <div className="px-4 sm:px-6 pb-6 border-t border-slate-200 pt-5">
          ...
          <section className="bg-amber-50 border border-amber-200 rounded-2xl p-8 text-center">
            ...
            <p className="text-slate-500 text-xs mt-3">We aim to respond to all speculative applications within 5 business days.</p>
          </section>
