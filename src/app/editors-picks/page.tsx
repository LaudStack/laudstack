...
const EDITORIAL_COLLECTIONS = [
  {
    ...
    description:
      "Impactful AI stacks, rigorously tested by our editorial team.",
...
function SpotlightCard({
  ...
  return (
    <div
      ...
      className={`group bg-slate-50 border-[1.5px] ${cc.cardBorder} rounded-2xl overflow-hidden cursor-pointer transition-all duration-200 ${cc.cardHover} hover:shadow-lg hover:-translate-y-0.5 flex flex-col h-full`}
    >
      {/* Accent top bar */}
      ...
      <div className="p-5 sm:p-7 flex-1 flex flex-col gap-4">
        ...
        {/* Stats row */}
        <div className="flex items-center gap-3 flex-wrap mt-auto pt-4 border-t border-slate-200">
...
function CompactCard({
  ...
  return (
    <div
      onClick={() => router.push(`/tools/${tool.slug}`)}
      className={`group bg-slate-50 border border-slate-200 rounded-xl px-3.5 sm:px-4 py-3 flex items-center gap-3 cursor-pointer transition-all duration-200 hover:shadow-md ${cc.cardHover} hover:-translate-y-0.5 shadow-sm`}
    >
      {/* Rank */}
...
function CollectionCard({
  ...
  return (
    <button
      onClick={onClick}
      className={`group text-left bg-slate-50 border-[1.5px] ${cc.cardBorder} rounded-2xl p-5 cursor-pointer transition-all duration-200 ${cc.cardHover} hover:shadow-lg hover:-translate-y-0.5 w-full`}
    >
      <div
      ...
      <p className="text-[12px] text-slate-600 leading-relaxed mb-3 line-clamp-2">
        {col.description}
      </p>
      <div
...
function SpotlightSkeleton() {
  return (
    <div className="bg-slate-50 border border-slate-200 rounded-2xl overflow-hidden animate-pulse">
...
function CompactSkeleton() {
  return (
    <div className="bg-slate-50 border border-slate-200 rounded-xl px-3.5 sm:px-4 py-3 flex items-center gap-3 shadow-sm animate-pulse">
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="relative border-b border-slate-200 pt-[60px] lg:pt-[64px] overflow-hidden" style={{ background: '#F8FAFC' }}>
        ...
        <div aria-hidden className="absolute" style={{ top: '-20%', right: '-5%', width: '500px', height: '400px', background: 'radial-gradient(ellipse at center, rgba(147, 51, 234, 0.05) 0%, transparent 70%)', pointerEvents: 'none' }} />
        <div aria-hidden className="absolute left-0 top-0 bottom-0" style={{ width: '3px', background: '#9333EA' }} />
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 pt-[30px] pb-[24px] relative z-[1]">
          {/* Breadcrumb — always left-aligned */}
          <Breadcrumbs items={[{ label: "Editor's Picks" }]} className="mb-3 sm:mb-4" />

          <div className="flex flex-col items-center text-center">
            <span className="inline-flex items-center gap-1.5 text-[11px] font-bold text-purple-800 bg-purple-100 border border-purple-200 px-2.5 py-1 rounded-full uppercase tracking-wider mb-2.5">
      ...
      {/* ══════════════════════════════════════════════════════
          HERO — ROW 2: Stats & Editorial Callout
      ══════════════════════════════════════════════════════ */}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex gap-3 sm:gap-4 flex-wrap justify-center sm:justify-start">
              {[
                ...
                <div
                  key={label}
                  className="text-center bg-slate-50 border border-slate-200 rounded-xl px-4 sm:px-5 py-3 min-w-[90px] sm:min-w-[100px]"
                >
                  <Icon className="w-[16px] h-[16px] text-purple-600 mx-auto mb-1" />
            ...
            <div className="flex-1 max-w-[520px] p-3.5 bg-purple-50 border border-purple-200 rounded-xl flex items-start gap-2.5">
              <Shield className="w-[16px] h-[16px] text-purple-600 shrink-0 mt-0.5" />
              <p className="text-[12px] text-purple-800 leading-relaxed m-0">
      ...
      <main className="bg-slate-50/60 py-8 sm:py-10">
        <div>
          ...
          <div className="mb-7">
            ...
            <p className="text-[14px] sm:text-[15px] text-slate-600 leading-relaxed max-w-xl">
              {active.description}
            </p>
          </div>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 sm:gap-6">
              ...
              <div className="flex flex-col gap-2.5">
                ...
                {listTools.length === 0 && (
                  <p className="text-[13px] text-slate-600 italic py-4">
      ...
      ══════════════════════════════════════════════════ */}
      <section className="bg-slate-50 border-t border-slate-200 py-12 sm:py-14">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
