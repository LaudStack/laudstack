    ...
    return (
      <div className="space-y-6 max-w-7xl">
        <div>
          ...
          <p className="text-sm text-slate-600 mt-0.5">Loading revenue data...</p>
        </div>
    ...
    return (
      <div className="space-y-6 max-w-7xl">
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div>
            <h1 className="text-2xl font-bold text-slate-900">Monetization & Revenue</h1>
            <p className="text-sm text-slate-600 mt-0.5">Track platform earnings and upgrade activity</p>
          </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-5">
          <div className="flex items-center justify-between mb-5">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">Revenue by month</p>
            </div>
          </div>
              ...
              {data.monthlyRevenue.map((m, i) => {
                ...
                return (
                  <div key={i} className="flex-1 flex flex-col items-center gap-1">
                    <span className="text-[11px] text-slate-500 font-medium">{formatCurrency(m.revenue)}</span>
                    <div
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-5">
          <div className="flex items-center justify-between mb-5">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">Breakdown by subscription tier</p>
            </div>
          </div>
