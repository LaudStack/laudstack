    ...
    <div className="min-h-screen flex flex-col" style={{ background: '#F8FAFC' }}>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap' }}>
          {!isLoading && savedTools.length > 0 && (
            <button
              ...
              style={{
                ...
                borderRadius: '9px', border: '1.5px solid #FEE2E2', background: '#FEF2F2',
          ...
          <button
            onClick={() => router.push('/')}
            style={{ display: 'flex', alignItems: 'center', gap: '6px', padding: '8px 14px', borderRadius: '9px', border: '1.5px solid #E2E8F0', background: '#F8FAFC', color: '#334155', fontWeight: 600, fontSize: '13px', cursor: 'pointer' }}
          >
      ...
      {/* ── Content ── */}
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10 pb-16 lg:pb-20 w-full flex-1">
        ...
        {isLoading ? (
          ...
          /* ── Empty state ── */
          <div
            className="flex flex-col items-center justify-center gap-5 py-12 sm:py-20 px-4 text-center"
          >
            <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl flex items-center justify-center" style={{ background: '#FFFBEB', border: '1.5px solid #FDE68A' }}>
              <Bookmark className="w-8 h-8 sm:w-9 sm:h-9" style={{ color: '#F59E0B' }} />
            </div>
            <div>
              <h2 style={{ fontFamily: "'Inter', sans-serif", fontSize: '26px', fontWeight: 900, color: '#0C1830', margin: '0 0 10px', letterSpacing: '-0.03em' }}>No saved stacks yet</h2>
            ...
            <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
              <Link
                href="/"
                style={{ display: 'inline-flex', alignItems: 'center', gap: '7px', padding: '12px 24px', borderRadius: '12px', background: '#F59E0B', color: '#0C1830', fontWeight: 700, fontSize: '14px', textDecoration: 'none', boxShadow: '0 4px 14px rgba(245,158,11,0.3)' }}
              >
                <Search style={{ width: '14px', height: '14px' }} /> Browse All Stacks
              </Link>
              <Link
                href="/categories"
                style={{ display: 'inline-flex', alignItems: 'center', gap: '7px', padding: '12px 24px', borderRadius: '12px', background: '#FFFFFF', color: '#334155', fontWeight: 700, fontSize: '14px', textDecoration: 'none', border: '1.5px solid #E2E8F0' }}
              >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' }}>
              <p style={{ fontSize: '14px', color: '#64748B', margin: 0 }}>
                <strong style={{ color: '#0C1830' }}>{savedTools.length}</strong> tool{savedTools.length !== 1 ? 's' : ''} saved
              </p>
              <p style={{ fontSize: '12px', color: '#64748B', margin: 0 }}>Sorted by most recently saved</p>
            </div>
