...
const SECTIONS: SitemapSection[] = [
  {
    ...
    links: [
      { label: 'Browse All Products', href: '/tools', desc: 'Full catalog of verified SaaS & AI stacks' },
      ...
      { label: 'Today\'s Launches', href: '/launches', desc: 'Launch leaderboard and recently launched tools' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Advertise', href: '/advertise', desc: 'Reach professionals with sponsored placements' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Marketplace', href: '/marketplace', desc: 'Buy and sell SaaS products, templates, and tools' },
    ...
    <div className="min-h-screen bg-white text-slate-900 flex flex-col">
      ...
      <div className="flex-1">
        ...
        breadcrumbs={[{ label: 'Sitemap' }]}
          ...
          subtitle="Every section and page, organized for easy navigation."
          accent="amber"
          layout="centered"
          size="md"
        />
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-16">
                      ...
                      <Link href={link.href}>
                        <div className="flex items-start gap-2 group cursor-pointer rounded-xl px-3 py-2 hover:bg-amber-50 transition-colors">
                          ...
                          <div>
                            ...
                            {link.desc && (
                              <div className="text-xs text-slate-500 mt-0.5 leading-relaxed">{link.desc}</div>
                            )}
                          </div>
                        </div>
                      </Link>
          ...
          <div className="mt-10 text-center text-xs text-slate-500">
            Sitemap last updated: March 2025
          </div>
        </div>
      </div>
      <Footer />
