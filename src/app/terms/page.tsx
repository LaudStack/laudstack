...
function LegalPage({ type }: LegalPageProps) {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <PageHero
        breadcrumbs={[{ label: 'Legal', href: '/terms' }, { label: 'Terms of Service' }]}
        eyebrow="Legal"
        title={content.title}
            ...
            <div className="sticky top-20 space-y-1">
              ...
              {content.sections.map((section) => (
                <a
                  ...
                  className="block text-xs text-slate-500 hover:text-amber-400 transition-colors py-1 border-l-2 border-slate-200 hover:border-amber-500 pl-3"
                >
                  {section.heading}
                </a>
              ))}
