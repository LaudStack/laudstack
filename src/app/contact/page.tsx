...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (message.trim().length > 3000) {
      toast.error('Message must be under 3,000 characters.');
      return;
    }
    ...
    <div className="min-h-screen bg-white text-slate-900 flex flex-col">
      ...
      <div className="flex-1">
        ...
        breadcrumbs={[{ label: 'Contact' }]}
          ...
          subtitle="Questions or feedback? We respond within 2 business days."
          accent="amber"
          layout="centered"
          size="md"
        />
        ...
        <div className="max-w-[1000px] mx-auto px-4 sm:px-6 py-10 sm:py-14">
          <div className="grid md:grid-cols-5 gap-8 lg:gap-10 items-start">
            ...
            <div className="md:col-span-3">
              {submitted ? (
                ...
                <form
                  ...
                  className="bg-slate-50 border border-slate-200 rounded-2xl p-6 sm:p-8 flex flex-col gap-5"
                  style={{ boxShadow: '0 1px 6px rgba(15,23,42,0.05)' }}
                  noValidate
                >
                  <div>
                    <h2 className="text-lg font-black text-slate-900" style={{ letterSpacing: '-0.02em' }}>
                      Send us a message
                    </h2>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        style={{ color: topic === '' ? '#94A3B8' : '#0C1830' }}
                      >
            ...
            <div className="md:col-span-2 flex flex-col gap-5">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-2xl p-5 sm:p-6"
                style={{ boxShadow: '0 1px 6px rgba(15,23,42,0.05)' }}>
                <h3 className="text-[11px] font-black text-slate-500 uppercase tracking-widest mb-4">Quick Links</h3>
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-2xl p-5 sm:p-6"
                style={{ boxShadow: '0 1px 6px rgba(15,23,42,0.05)' }}>
                <h3 className="text-[11px] font-black text-slate-500 uppercase tracking-widest mb-4">Response Times</h3>
          ...
          <div className="mt-14 sm:mt-16">
            <div className="mb-6">
              <p className="text-[11px] font-extrabold text-slate-500 uppercase tracking-widest mb-1">FAQ</p>
              <h2 className="text-xl sm:text-2xl font-black text-slate-900" style={{ letterSpacing: '-0.02em' }}>
                Frequently Asked Questions
              </h2>
            </div>
            <div className="flex flex-col gap-2.5">
              {FAQ.map((item, i) => (
                <div key={i} className="bg-slate-50 border border-slate-200 rounded-xl overflow-hidden transition-all"
                  ...
                  {openFaq === i && (
                    <div className="px-5 sm:px-6 pb-4 border-t border-slate-200">
