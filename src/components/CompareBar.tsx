  ...
  return (
    <>
      {selected.length > 0 && (
        ...
        >
          <div style={{
            background: '#0C1830', borderRadius: '16px',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flex: '1 1 auto', minWidth: 0, overflowX: 'auto', padding: '2px 0' }}>
              {selected.map(tool => (
                ...
                >
                  <div style={{ width: '22px', height: '22px', borderRadius: '6px', overflow: 'hidden', background: '#0C1830', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexShrink: 0 }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: selected.length >= 2 ? '#F59E0B' : '#0C1830',
