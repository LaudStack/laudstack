...
import { X, LogIn, Star, Bookmark, Tag, MessageSquare } from "lucide-react";
...
> = {
  ...
  claim: {
    ...
    description:
      "Verify ownership of your stack and unlock Pro founder features. Sign in to start the claiming process.",
  },
  claim_deal: {
    icon: Tag,
