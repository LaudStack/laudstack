...
function CommentComposer({
  ...
  return (
    <div
      className={`bg-slate-50 border rounded-xl transition-all ${
        isReply
          ? "border-slate-200"
    ...
    >
      <textarea
        ...
        className="w-full resize-none border-none bg-transparent text-sm text-slate-900 placeholder:text-slate-500 focus:outline-none focus:ring-0"
        style={{
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            style={{
              ...
              color: hasContent && !submitting ? "#0C1830" : "#94A3B8",
            }}
          >
            {submitting ? (
    ...
    return (
      <div className={`flex gap-3 ${isReply ? "ml-0" : ""} opacity-60`}>
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[13px] text-slate-600 italic leading-relaxed m-0">
        ...
        {editing ? (
          <div className="mt-1">
            <textarea
              ...
              className="w-full resize-none border border-slate-200 rounded-lg bg-slate-50 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-amber-200 focus:border-amber-300 transition-all"
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <button
                ...
                className="inline-flex items-center gap-1 px-3 py-1.5 rounded-md text-xs font-bold bg-amber-400 text-slate-900 border-none cursor-pointer transition-all disabled:opacity-40 hover:bg-amber-500"
              >
                {saving ? (
          ...
          <div className="flex items-center gap-3 mt-2">
            ...
            {!isReply && (
              <button
                ...
                className="inline-flex items-center gap-1 text-[11px] font-semibold text-slate-500 hover:text-amber-600 bg-transparent border-none cursor-pointer transition-colors px-0"
              >
            ...
            {isOwner && !confirmDelete && (
              <>
                <button
                  ...
                  className="inline-flex items-center gap-1 text-[11px] font-semibold text-slate-500 hover:text-blue-600 bg-transparent border-none cursor-pointer transition-colors px-0"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1 text-[11px] font-semibold text-slate-500 hover:text-red-600 bg-transparent border-none cursor-pointer transition-colors px-0"
                >
...
function CommentsFallback() {
  return (
    <section
      id="section-comments"
      className="bg-slate-50 rounded-2xl border border-slate-200 p-5 sm:p-7"
    ...
    >
      ...
      <div className="flex items-center justify-between gap-3 mb-5 sm:mb-6 flex-wrap">
        <div className="flex items-center gap-2.5">
          <h2
            className="text-base sm:text-lg font-extrabold text-slate-900 m-0"
          ...
          {commentsList.map((comment) => (
            <div key={comment.id}>
              ...
              {comment.replies.length > 0 && (
                <div className="ml-8 sm:ml-12 mt-3 flex flex-col gap-3 pl-4 border-l-2 border-slate-200">
