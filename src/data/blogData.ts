...
export const AUTHORS: Record<string, Author> = {
  ...
  // Legacy author keys mapped to LaudStack Team for backward compatibility
  'Sarah Chen': {
    name: 'LaudStack Team',
    role: 'Editorial',
    avatar: 'LS',
    bio: 'The LaudStack editorial team researches, tests, and writes about the products and trends shaping the SaaS and AI landscape.',
  },
  'Marcus Webb': {
    name: 'LaudStack Team',
    role: 'Editorial',
