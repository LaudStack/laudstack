...
const MOCK_TOOLS = [
  {
    ...
    features: JSON.stringify([{icon:"🎯",title:"Brand Voice",description:"Train Jasper on your brand guidelines, tone, and style so every piece of content sounds authentically yours."},{icon:"📋",title:"50+ Templates",description:"Pre-built templates for blog posts, ad copy, emails, social media, product descriptions, and more."},{icon:"🤝",title:"Team Collaboration",description:"Real-time collaborative editing, content calendars, and approval workflows for marketing teams."},{icon:"🔗",title:"Integrations",description:"Connect with Surfer SEO, Grammarly, Google Docs, WordPress, HubSpot, and 20+ other products."},{icon:"🌍",title:"30+ Languages",description:"Create content in over 30 languages with native-quality output for global marketing campaigns."},{icon:"📈",title:"SEO Mode",description:"Integrated SEO optimization with keyword suggestions, readability scoring, and SERP analysis."}]),
    pricing_tiers: JSON.stringify([{name:"Creator",price:"$49/mo",period:"per month",description:"For individual content creators and freelancers.",features:["1 user seat","Brand voice (1 profile)","50+ templates","SEO mode","Browser extension"],cta:"Start Free Trial"},{name:"Teams",price:"$125/mo",period:"per month",description:"For marketing teams that need collaboration.",features:["3 user seats","Brand voice (3 profiles)","Collaboration tools","Campaign workflows","Priority support","API access"],cta:"Start Free Trial",highlighted:true,badge:"Most Popular"},{name:"Business",price:"Custom",description:"For enterprises with advanced needs.",features:["Unlimited seats","Custom brand voices","SSO","Dedicated CSM","Custom integrations","SLA"],cta:"Contact Sales"}]),
  },
  {
  ...
  },
  {
    ...
    features: JSON.stringify([{icon:"🎨",title:"Photorealistic Output",description:"Generate stunning photorealistic images, concept art, and illustrations from natural language descriptions."},{icon:"🔧",title:"Fine-grained Control",description:"Advanced parameters for aspect ratio, style weight, chaos, quality, and seed for reproducible results."},{icon:"🔄",title:"Variations & Upscaling",description:"Generate multiple variations of any image and upscale to 4× resolution with detail enhancement."},{icon:"👁️",title:"Image Prompting",description:"Use reference images to guide style, composition, and subject matter in generated outputs."},{icon:"🌐",title:"Web Interface",description:"New web app with image organization, prompt history, and a gallery of community creations."},{icon:"⚡",title:"Fast Mode",description:"GPU-accelerated fast mode for rapid iteration, with relaxed mode for unlimited slower generations."}]),
    pricing_tiers: JSON.stringify([{name:"Basic",price:"$10/mo",period:"per month",description:"For hobbyists and casual creators.",features:["~200 image generations/mo","General commercial terms","Access to member gallery","3 concurrent jobs"],cta:"Subscribe"},{name:"Standard",price:"$30/mo",period:"per month",description:"For active creators and professionals.",features:["15 hr fast GPU time/mo","Unlimited relaxed generations","General commercial terms","3 concurrent fast jobs"],cta:"Subscribe",highlighted:true,badge:"Most Popular"},{name:"Pro",price:"$60/mo",period:"per month",description:"For power users and agencies.",features:["30 hr fast GPU time/mo","Stealth mode (private generations)","12 concurrent fast jobs","General commercial terms"],cta:"Subscribe"},{name:"Mega",price:"$120/mo",period:"per month",description:"Maximum speed and capacity.",features:["60 hr fast GPU time/mo","Stealth mode","12 concurrent fast jobs","Priority queue"],cta:"Subscribe"}]),
  },
  {
  ...
  },
  {
    ...
    features: JSON.stringify([{icon:"⌨️",title:"Inline Completions",description:"Context-aware code completions that understand your codebase, comments, and variable names."},{icon:"💬",title:"Copilot Chat",description:"Ask questions about your code, get explanations, debug errors, and generate tests in natural language."},{icon:"🔍",title:"Code Review",description:"Automated pull request summaries, security vulnerability detection, and code quality suggestions."},{icon:"🧪",title:"Test Generation",description:"Automatically generate unit tests, edge cases, and test suites for your existing code."},{icon:"🛠️",title:"Multi-IDE Support",description:"Works with VS Code, Visual Studio, JetBrains IDEs, Neovim, and GitHub.com."},{icon:"🔐",title:"Enterprise Security",description:"No code stored beyond the session, IP indemnity, and enterprise-grade access controls."}]),
    pricing_tiers: JSON.stringify([{name:"Individual",price:"$10/mo",period:"per month",description:"For individual developers.",features:["Unlimited completions","Copilot Chat","CLI assistance","All IDE integrations"],cta:"Start Free Trial"},{name:"Business",price:"$19/mo",period:"per user/month",description:"For teams with management and policy controls.",features:["Everything in Individual","Organization-wide policy","Audit logs","IP indemnity","SAML SSO"],cta:"Start Free Trial",highlighted:true,badge:"Most Popular"},{name:"Enterprise",price:"$39/mo",period:"per user/month",description:"For large organizations with custom needs.",features:["Everything in Business","Fine-tuned models on your codebase","GitHub.com Copilot Chat","Dedicated support","Custom policies"],cta:"Contact Sales"}]),
  },
  {
  ...
  },
  {
    ...
    features: JSON.stringify([{icon:"📚",title:"200K Token Context",description:"Process entire codebases, legal documents, or books in a single conversation — the largest context window available."},{icon:"🛡️",title:"Constitutional AI",description:"Built with Anthropic's safety-first approach, Claude is designed to be helpful, harmless, and honest."},{icon:"✍️",title:"Superior Writing",description:"Nuanced, human-like writing for essays, reports, creative fiction, and technical documentation."},{icon:"🔬",title:"Deep Analysis",description:"Complex reasoning across multi-step problems, research synthesis, and structured argument evaluation."},{icon:"💻",title:"Code Generation",description:"Write, review, debug, and explain code across 20+ programming languages with detailed explanations."},{icon:"🌐",title:"API Access",description:"Integrate Claude into your products via a clean REST API with streaming, function calling, and vision support."}]),
    pricing_tiers: JSON.stringify([{name:"Free",price:"$0",description:"Get started with the essentials at no cost.",features:["Up to 10,000 words/month","Basic templates","Email support","1 user seat"],cta:"Get Started Free"},{name:"Pro",price:"$20/mo",period:"per month",description:"Everything in Free, plus powerful features for professionals.",features:["Unlimited words","All templates & modes","Priority support","5 user seats","API access","200K context window","Claude 3.5 Sonnet & Opus","Priority access"],cta:"Start Free Trial",highlighted:true,badge:"Most Popular"},{name:"Enterprise",price:"Custom",description:"Tailored plans for large teams and organizations.",features:["Everything in Pro","Unlimited seats","SSO & SAML","Dedicated account manager","Custom integrations","SLA guarantee"],cta:"Contact Sales"}]),
  },
  {
    ...
    features: JSON.stringify([{icon:"💬",title:"Advanced Conversations",description:"Multi-turn dialogue with memory, context retention, and nuanced understanding across long sessions."},{icon:"🖼️",title:"Image Generation",description:"Create stunning images from text prompts using DALL·E 3 directly inside the chat interface."},{icon:"🔌",title:"Plugin Ecosystem",description:"Connect to 1,000+ third-party plugins for browsing, code execution, data analysis, and more."},{icon:"📊",title:"Advanced Data Analysis",description:"Upload CSVs, PDFs, and images. ChatGPT can analyze, chart, and summarize complex datasets."},{icon:"🗣️",title:"Voice Mode",description:"Natural real-time voice conversations with emotional awareness and multiple voice styles."},{icon:"🔒",title:"Enterprise Security",description:"SOC 2 compliant, no training on your data, SSO, and custom data retention policies."}]),
    pricing_tiers: JSON.stringify([{name:"Free",price:"$0",description:"Access GPT-3.5 and limited GPT-4o features.",features:["GPT-3.5 & limited GPT-4o","DALL·E image generation","Web browsing","Standard response speed"],cta:"Start Free"},{name:"Plus",price:"$20/mo",period:"per month",description:"Full GPT-4o access with higher limits and new features first.",features:["GPT-4o & GPT-4","DALL·E 3 (unlimited)","Advanced Data Analysis","Voice Mode","Early access to new features","5× more messages"],cta:"Upgrade to Plus",highlighted:true,badge:"Most Popular"},{name:"Team",price:"$30/mo",period:"per user/month",description:"Collaborative workspace with admin controls.",features:["Everything in Plus","Shared workspace","Admin console","No training on your data","Higher rate limits"],cta:"Start Team Trial"},{name:"Enterprise",price:"Custom",description:"Unlimited, secure, and fully customizable.",features:["Unlimited GPT-4o","SSO & SAML","Custom data retention","Dedicated account manager","SLA & compliance"],cta:"Contact Sales"}]),
  },
  {
    slug: "salesforce", name: "Salesforce", tagline: "The world's #1 CRM platform",
    description: "Salesforce is the world's leading CRM platform, helping businesses of all sizes manage customer relationships, sales pipelines, marketing campaigns, and service operations with AI-powered insights.",
    logo_url: "https://www.google.com/s2/favicons?domain=salesforce.com&sz=64",
    website_url: "https://salesforce.com", category: "CRM", pricing_model: "Paid",
    tags: JSON.stringify(["CRM", "sales", "enterprise", "AI"]),
    badges: JSON.stringify(["top_rated", "verified"]),
    status: "approved", is_featured: true, is_verified: true, is_pro: true,
    upvote_count: 3200, review_count: 1800, average_rating: 4.5, rank_score: 9400, weekly_rank_change: 3,
    launched_at: "1999-02-01",
  },
  {
    slug: "outreach", name: "Outreach", tagline: "Sales execution platform for revenue teams",
    description: "Outreach is the leading sales execution platform that helps revenue teams create and close more pipeline. AI-powered workflows, sequencing, and analytics for modern sales teams.",
    logo_url: "https://www.google.com/s2/favicons?domain=outreach.io&sz=64",
    website_url: "https://outreach.io", category: "Sales", pricing_model: "Paid",
    tags: JSON.stringify(["sales", "outreach", "pipeline", "AI"]),
    badges: JSON.stringify(["verified"]),
    status: "approved", is_featured: false, is_verified: true, is_pro: false,
    upvote_count: 890, review_count: 320, average_rating: 4.3, rank_score: 8500, weekly_rank_change: 5,
    launched_at: "2014-01-01",
  },
  {
    slug: "bamboohr", name: "BambooHR", tagline: "HR software for growing companies",
    description: "BambooHR is the leading HR platform for small and medium businesses. Manage hiring, onboarding, compensation, performance, and culture in one easy-to-use system.",
    logo_url: "https://www.google.com/s2/favicons?domain=bamboohr.com&sz=64",
    website_url: "https://bamboohr.com", category: "HR & Recruiting", pricing_model: "Paid",
    tags: JSON.stringify(["HR", "recruiting", "onboarding", "people"]),
    badges: JSON.stringify(["verified", "community_pick"]),
    status: "approved", is_featured: false, is_verified: true, is_pro: false,
    upvote_count: 1100, review_count: 480, average_rating: 4.6, rank_score: 8700, weekly_rank_change: 2,
    launched_at: "2008-06-01",
  },
  {
    slug: "quickbooks", name: "QuickBooks", tagline: "Accounting software for small businesses",
    description: "QuickBooks by Intuit is the most popular accounting software for small businesses. Track income and expenses, send invoices, manage payroll, and run financial reports with ease.",
    logo_url: "https://www.google.com/s2/favicons?domain=quickbooks.intuit.com&sz=64",
    website_url: "https://quickbooks.intuit.com", category: "Finance", pricing_model: "Paid",
    tags: JSON.stringify(["accounting", "finance", "invoicing", "payroll"]),
    badges: JSON.stringify(["top_rated", "verified"]),
    status: "approved", is_featured: false, is_verified: true, is_pro: false,
    upvote_count: 2400, review_count: 1200, average_rating: 4.4, rank_score: 9100, weekly_rank_change: 1,
    launched_at: "1983-01-01",
  },
  {
    slug: "crowdstrike", name: "CrowdStrike", tagline: "AI-native cybersecurity platform",
    description: "CrowdStrike provides cloud-native endpoint and workload protection. The Falcon platform uses AI to detect and prevent breaches in real time across endpoints, cloud workloads, and identities.",
    logo_url: "https://www.google.com/s2/favicons?domain=crowdstrike.com&sz=64",
    website_url: "https://crowdstrike.com", category: "Security", pricing_model: "Paid",
    tags: JSON.stringify(["security", "endpoint", "AI", "cloud"]),
    badges: JSON.stringify(["verified"]),
    status: "approved", is_featured: false, is_verified: true, is_pro: false,
    upvote_count: 950, review_count: 280, average_rating: 4.5, rank_score: 8600, weekly_rank_change: 4,
    launched_at: "2011-11-01",
  },
  {
    slug: "woocommerce", name: "WooCommerce", tagline: "Open-source e-commerce for WordPress",
    description: "WooCommerce is the most popular open-source e-commerce solution. Built on WordPress, it powers millions of online stores with flexible product management, payments, shipping, and extensions.",
    logo_url: "https://www.google.com/s2/favicons?domain=woocommerce.com&sz=64",
    website_url: "https://woocommerce.com", category: "E-commerce", pricing_model: "Free",
    tags: JSON.stringify(["e-commerce", "WordPress", "online store", "open source"]),
    badges: JSON.stringify(["community_pick", "verified"]),
    status: "approved", is_featured: false, is_verified: true, is_pro: false,
    upvote_count: 2800, review_count: 1500, average_rating: 4.3, rank_score: 9000, weekly_rank_change: -1,
    launched_at: "2011-09-01",
  },
  {
    slug: "duolingo", name: "Duolingo", tagline: "AI-powered language learning platform",
    description: "Duolingo is the world's most popular language learning platform. Learn 40+ languages with AI-powered lessons, gamification, and personalized learning paths used by 500M+ learners worldwide.",
    logo_url: "https://www.google.com/s2/favicons?domain=duolingo.com&sz=64",
    website_url: "https://duolingo.com", category: "Education", pricing_model: "Freemium",
    tags: JSON.stringify(["education", "language", "AI", "gamification"]),
    badges: JSON.stringify(["top_rated", "community_pick", "verified"]),
    status: "approved", is_featured: true, is_verified: true, is_pro: true,
    upvote_count: 3500, review_count: 2100, average_rating: 4.7, rank_score: 9500, weekly_rank_change: 6,
    launched_at: "2012-06-19",
  },
  {
    slug: "freshdesk", name: "Freshdesk", tagline: "Customer support software with AI",
    description: "Freshdesk by Freshworks is a cloud-based customer support platform. Manage tickets, automate workflows, and provide omnichannel support with AI-powered chatbots and self-service portals.",
    logo_url: "https://www.google.com/s2/favicons?domain=freshdesk.com&sz=64",
    website_url: "https://freshdesk.com", category: "Customer Support", pricing_model: "Freemium",
    tags: JSON.stringify(["support", "helpdesk", "ticketing", "AI"]),
    badges: JSON.stringify(["verified"]),
    status: "approved", is_featured: false, is_verified: true, is_pro: false,
    upvote_count: 1300, review_count: 560, average_rating: 4.4, rank_score: 8800, weekly_rank_change: 3,
    launched_at: "2010-10-01",
  },
  {
    slug: "hootsuite", name: "Hootsuite", tagline: "Social media management platform",
    description: "Hootsuite is the global leader in social media management. Schedule posts, monitor conversations, measure ROI, and manage all your social media channels from one dashboard with AI-powered insights.",
    logo_url: "https://www.google.com/s2/favicons?domain=hootsuite.com&sz=64",
    website_url: "https://hootsuite.com", category: "Marketing", pricing_model: "Paid",
    tags: JSON.stringify(["social media", "marketing", "scheduling", "analytics"]),
    badges: JSON.stringify(["verified"]),
    status: "approved", is_featured: false, is_verified: true, is_pro: false,
    upvote_count: 1800, review_count: 750, average_rating: 4.2, rank_score: 8900, weekly_rank_change: -2,
    launched_at: "2008-12-01",
  },
  {
    slug: "zapier", name: "Zapier", tagline: "Automate workflows between 6,000+ apps",
    description: "Zapier is the leading no-code automation platform that connects 6,000+ apps. Create automated workflows (Zaps) to move data between tools, trigger actions, and eliminate repetitive tasks without writing code.",
    ...
    tags: JSON.stringify(["automation", "no-code", "integrations", "workflow"]),
    badges: JSON.stringify(["top_rated", "community_pick", "verified"]),
    status: "approved", is_featured: true, is_verified: true, is_pro: true,
    upvote_count: 4100, review_count: 2200, average_rating: 4.7, rank_score: 9600, weekly_rank_change: 4,
    launched_at: "2012-10-01",
  },
  {
    slug: "slack", name: "Slack", tagline: "AI-powered messaging for teams",
    description: "Slack is the AI-powered platform for work that connects people, tools, and information. Channels, huddles, workflows, and integrations with 2,600+ apps keep teams aligned and productive.",
    logo_url: "https://www.google.com/s2/favicons?domain=slack.com&sz=64",
    website_url: "https://slack.com", category: "Project Management", pricing_model: "Freemium",
    tags: JSON.stringify(["messaging", "collaboration", "teams", "AI"]),
    badges: JSON.stringify(["top_rated", "verified"]),
    status: "approved", is_featured: true, is_verified: true, is_pro: true,
    upvote_count: 5200, review_count: 2800, average_rating: 4.6, rank_score: 9700, weekly_rank_change: 1,
    launched_at: "2013-08-14",
  },
];
...
async function seed() {
  ...
  for (const tool of MOCK_TOOLS) {
    await sql`
      INSERT INTO tools (slug, name, tagline, description, logo_url, website_url, category, pricing_model, tags, badges, status, is_featured, is_verified, is_pro, upvote_count, review_count, average_rating, rank_score, weekly_rank_change, launched_at, features, pricing_tiers, created_at, updated_at)
      VALUES (${tool.slug}, ${tool.name}, ${tool.tagline}, ${tool.description}, ${tool.logo_url}, ${tool.website_url}, ${tool.category}, ${tool.pricing_model}, ${tool.tags}::jsonb, ${tool.badges}::jsonb, ${tool.status}, ${tool.is_featured}, ${tool.is_verified}, ${tool.is_pro}, ${tool.upvote_count}, ${tool.review_count}, ${tool.average_rating}, ${tool.rank_score}, ${tool.weekly_rank_change}, ${tool.launched_at}, ${tool.features || null}::jsonb, ${tool.pricing_tiers || null}::jsonb, NOW(), NOW())
    `;
