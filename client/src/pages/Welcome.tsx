...
const ONBOARDING_STEPS = [
  {
    ...
    description: 'Browse AI and SaaS tools across 15 categories. Use Cmd+K to search instantly.',
    cta: 'Browse Tools',
    href: '/tools',
    color: 'text-sky-500',
    bg: 'bg-sky-50',
  ...
  },
  {
    ...
    description: 'Share your experience with a tool you\'ve used. Your review helps thousands of buyers.',
        ...
        <div className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 py-16 text-center relative">
            ...
            <p className="text-slate-400 text-lg max-w-xl mx-auto leading-relaxed">
              You're now part of a community of 12,400+ buyers, founders, and reviewers shaping the future of AI & SaaS.
            </p>
