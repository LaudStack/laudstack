            ...
            <div className="lg:col-span-2">
              ...
              {step === 'verify' && selectedTool && (
                <div className="bg-white/60 border border-gray-300/60 rounded-2xl p-6">
                  ...
                  <p className="text-slate-500 text-sm mb-6">Choose how you'd like to prove you own or represent this tool.</p>
              ...
              {step === 'details' && (
                <form onSubmit={handleSubmit} className="bg-white/60 border border-gray-300/60 rounded-2xl p-6">
                  ...
                  <div className="mb-6">
                    ...
                    <textarea value={founderBio} onChange={e => setFounderBio(e.target.value)} rows={3} placeholder="Tell us about your background and why you built this tool..." className="w-full bg-gray-100 border border-gray-300 rounded-xl px-4 py-3 text-slate-900 placeholder-gray-400 text-sm focus:outline-none focus:border-amber-400 transition-colors resize-none" />
                  </div>
