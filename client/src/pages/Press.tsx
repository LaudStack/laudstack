...
const MEDIA_COVERAGE = [
  ...
  {
    outlet: 'Product Hunt',
    headline: '#1 Product of the Day — LaudStack launches to 2,400 upvotes',
    date: 'January 2025',
    url: '#',
  },
  {
          ...
          <section>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-7">
              ...
              <p className="text-slate-600 text-sm leading-relaxed mb-4">
                LaudStack is the trusted discovery and review platform for AI and SaaS tools. Founded in 2024, LaudStack helps over 12,000 professionals — including founders, product managers, engineers, and marketers — discover, compare, and choose the software that powers their work.
              </p>
              <p className="text-slate-600 text-sm leading-relaxed mb-4">
                Unlike generic software directories, LaudStack combines verified community reviews, a transparent algorithmic ranking system, and an editorial curation layer to surface the tools that genuinely perform. Every tool on the platform is manually reviewed before listing, and every review is verified against real usage.
              </p>
