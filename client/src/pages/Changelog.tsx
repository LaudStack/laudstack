...
const RELEASES = [
  {
    ...
    changes: [
      ...
      { type: 'feature', icon: Star, text: 'Saved Tools with bookmark icon on every card, persisted to localStorage' },
      { type: 'feature', icon: Users, text: 'User avatar dropdown in navbar with profile, saved tools, and sign-out' },
  ...
  },
  {
    ...
    changes: [
      ...
      { type: 'feature', icon: TrendingUp, text: 'Trending section on homepage with weekly rank-change momentum indicators' },
      { type: 'feature', icon: Users, text: 'User Dashboard with profile, reviews, saved tools, and settings tabs' },
  ...
  },
  {
    ...
    summary: 'Pricing, Templates, Deals & Claim Tool',
    changes: [
  ...
  },
  {
    ...
    changes: [
      { type: 'feature', icon: Rocket, text: 'Homepage with hero search, featured tools, and category browser' },
      { type: 'feature', icon: Package, text: 'Tool detail pages with ratings, reviews, and upvote system' },
