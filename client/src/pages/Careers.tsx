...
const OPEN_ROLES: Job[] = [
  {
    ...
    remote: true,
    level: 'Senior',
    description: 'Own and evolve core platform features — from the tool discovery engine to the review system. You\'ll work across the full stack (TypeScript, React, Node.js, MySQL) and have a direct impact on how 12,000+ professionals find their next tool.',
    requirements: [
  ...
  },
  {
    ...
    requirements: [
      ...
      'Interest in AI and SaaS tools is a big plus',
    ],
    posted: '1 month ago',
  },
];
...
const PERKS = [
  ...
  { icon: <Zap className="w-5 h-5 text-amber-500" />, title: 'Tool Allowance', desc: 'Unlimited access to every tool on LaudStack, plus a $500/year budget for any SaaS subscriptions you need.' },
];
