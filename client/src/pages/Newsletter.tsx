...
const BENEFITS = [
  ...
  },
  {
    ...
    desc: 'New tools submitted by founders this week — be the first to discover and review them.',
  },
  {
...
const SOCIAL_PROOF = [
  { name: 'Sarah K.', role: 'Product Manager', quote: 'The only newsletter I actually open every Monday. The trending picks are always spot-on.' },
    ...
    <div className="min-h-screen bg-gray-50 text-slate-900 flex flex-col">
      ...
      <div className="flex-1">
        <PageHero
          ...
          title="The best AI & SaaS tools, curated every Monday."
          subtitle="Join 12,000+ professionals who start their week with the LaudStack digest — trending tools, editor picks, fresh launches, and community insights in one email."
          accent="amber"
          layout="centered"
          size="lg"
        />
        ...
        <div className="max-w-5xl mx-auto px-6 py-16 space-y-20">
          ...
          <section>
            <div className="text-center mb-8">
              ...
              <h2 className="text-3xl font-black text-slate-900">This week's trending picks</h2>
