  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F8FAFC', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ background: '#FFFFFF', borderBottom: '1px solid #E8ECF0', position: 'sticky', top: '64px', zIndex: 40 }}>
        <div className="max-w-[1280px] mx-auto px-6 lg:px-10" style={{ paddingTop: '14px', paddingBottom: '14px' }}>
      ...
      {/* ── Content ── */}
      <div className="max-w-[1280px] mx-auto w-full px-6 lg:px-10" style={{ paddingTop: '32px', paddingBottom: '64px', flex: 1 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            {visibleTools.map((tool, i) => (
              <motion.div
                ...
                whileHover={{ borderColor: '#FCD34D', boxShadow: '0 4px 16px rgba(0,0,0,0.08)' }}
              >
                {/* Logo */}
                <div style={{
