      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', width: '100%', padding: '32px 24px 64px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '24px', flexWrap: 'wrap' }}>
          ...
          <div style={{
            ...
            padding: '8px 12px', flex: '1', minWidth: '200px', maxWidth: '320px',
          }}>
        ...
        {trendingTools.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '80px 0' }}>
            ...
            <p style={{ fontSize: '14px', color: '#9CA3AF' }}>
              {query ? `No trending tools match "${query}"` : 'Try selecting "All Categories"'}
            </p>
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ fontSize: '13px', color: '#6B7280' }}>
                Submit your AI or SaaS tool and let the community decide where it ranks.
              </div>
            </div>
            <button
