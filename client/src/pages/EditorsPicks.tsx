        ...
        <div className="max-w-[1300px] mx-auto px-6 lg:px-10">
          <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 24, flexWrap: 'wrap' }}>
            <div>
              ...
              <p style={{ fontSize: 16, color: '#64748B', maxWidth: 540, lineHeight: 1.65, margin: 0 }}>
                Every tool here has been individually tested, reviewed, and selected by the LaudStack editorial team for outstanding quality, innovation, and real-world value.
              </p>
            </div>
            {/* Stats */}
          ...
          <div style={{ marginTop: 28, padding: '14px 20px', background: '#FAF5FF', border: '1px solid #E9D5FF', borderRadius: 12, display: 'flex', alignItems: 'flex-start', gap: 12 }}>
            ...
            <p style={{ fontSize: 13, color: '#6B21A8', lineHeight: 1.6, margin: 0 }}>
              <strong>Editorial Independence:</strong> Our picks are never paid placements. Every tool is evaluated against our editorial rubric covering functionality, UX, support quality, pricing fairness, and community reception. Founders cannot purchase an Editor's Pick badge.
            </p>
          </div>
        </div>
      </section>
