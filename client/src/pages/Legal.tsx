    ...
    sections: [
      {
        ...
        content: `We collect information you provide directly to us, such as when you create an account, submit a tool, write a review, or contact us. This includes your name, email address, profile information, and any content you submit.\n\nWe also collect information automatically when you use LaudStack, including log data (IP address, browser type, pages visited), device information, and usage patterns through analytics tools.`,
      },
      {
      ...
      },
      {
        ...
        content: `Depending on your location, you may have certain rights regarding your personal information, including the right to access, correct, or delete your data; the right to object to or restrict processing; and the right to data portability.\n\nTo exercise these rights, please contact us at privacy@laudstack.com.`,
      },
      {
  ...
  terms: {
    ...
    sections: [
      ...
      },
      {
        ...
        content: `You retain ownership of content you submit to LaudStack, including reviews, ratings, and tool submissions. By submitting content, you grant LaudStack a worldwide, non-exclusive, royalty-free license to use, display, and distribute your content in connection with the Service.\n\nYou are solely responsible for your content and must not submit false, misleading, defamatory, or fraudulent reviews.`,
      },
      {
        heading: '4. Prohibited Conduct',
        content: `You agree not to: submit fake or incentivized reviews; manipulate rankings through artificial means; impersonate other users or entities; use the Service for any unlawful purpose; attempt to gain unauthorized access to our systems; or interfere with the proper functioning of the Service.`,
      },
      {
        heading: '5. Tool Listings',
        content: `Founders who submit tools to LaudStack represent that they have the right to do so and that all information provided is accurate. LaudStack reserves the right to remove or modify any listing that violates our guidelines or contains inaccurate information.`,
      },
      {
      ...
      },
      {
        ...
        content: `The Service is provided "as is" without warranties of any kind. LaudStack does not warrant that the Service will be uninterrupted, error-free, or that reviews and ratings accurately reflect the quality of listed tools.`,
      },
      {
...
export default function Legal() {
  ...
  const type: LegalType = location.includes('terms') ? 'terms' : location.includes('cookies') ? 'cookies' : 'privacy';
