...
const SECTIONS: SitemapSection[] = [
  {
    ...
    links: [
      ...
      { label: 'Compare Tools', href: '/compare', desc: 'Side-by-side tool comparison' },
      { label: 'Saved Tools', href: '/saved', desc: 'Your personal tool shortlist' },
  ...
  },
  {
    ...
    links: [
      { label: 'LaunchPad', href: '/launchpad', desc: 'Submit your tool and get discovered' },
      { label: 'Claim Your Tool', href: '/claim', desc: 'Claim an existing listing and manage your profile' },
