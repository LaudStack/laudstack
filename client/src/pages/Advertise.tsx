...
const TIERS = [
  ...
  },
  {
    ...
    features: [
      ...
      'Homepage trending section priority slot',
    ...
    <div className="min-h-screen bg-gray-50 text-slate-900 flex flex-col">
      ...
      <div className="flex-1">
        <PageHero
          ...
          subtitle="LaudStack is where decision-makers come to discover, compare, and choose AI & SaaS tools. Put your product in front of buyers who are ready to act."
          accent="amber"
          layout="centered"
          size="lg"
        />
