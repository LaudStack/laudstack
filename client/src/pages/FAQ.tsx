...
const FAQ_CATEGORIES = [
  {
    ...
    questions: [
      {
        q: 'What is LaudStack?',
        a: 'LaudStack is a professional discovery and review platform for AI and SaaS tools. We help businesses and professionals find, compare, and evaluate the best software tools through verified community reviews, editorial curation, and data-driven rankings. Think of us as the trusted source for software intelligence — combining the depth of G2 with the discovery energy of ProductHunt.',
      },
      {
      ...
      },
      {
        ...
        a: 'LaudStack combines the verified review depth of G2 with the community-driven discovery energy of ProductHunt. We focus specifically on AI and SaaS tools, maintain stricter review verification standards, and provide real-time trend data alongside editorial curation. Our Community Picks and Editor\'s Picks systems give you both crowd wisdom and expert guidance in one place.',
      },
      {
        q: 'How often is the platform updated?',
        a: 'New tools are added daily as founders submit via LaunchPad. Rankings are recalculated weekly based on fresh review data and community votes. Our editorial team publishes new picks and collections every week. The Changelog page documents all significant platform updates.',
      },
      {
    ...
    questions: [
      {
        ...
        a: 'Go to the LaunchPad page and complete the submission form. You\'ll need to provide your tool\'s name, tagline, description, logo, website URL, category, and pricing model. Submissions are reviewed by our team within 2–3 business days. There is no fee to list a tool.',
      },
      {
        q: 'What is the LaunchPad?',
        a: 'LaunchPad is LaudStack\'s dedicated submission and launch hub for founders. When you submit via LaunchPad, your tool gets a dedicated launch day feature, appears in the "Fresh Launches" section on the homepage, and is eligible for community upvotes and editorial review. It\'s the fastest path to getting discovered.',
      },
      {
        q: 'How do I claim my tool\'s profile?',
        a: 'Visit the Claim Your Tool page and verify ownership by confirming access to the tool\'s registered email domain or by adding a DNS TXT record. Once verified, you\'ll receive a "Verified Founder" badge and unlock the Founder Dashboard with analytics and review management tools.',
      },
      {
      ...
      },
      {
        ...
        a: 'The Founder Dashboard shows profile views, click-throughs to your website, review trends over time, rating breakdowns, upvote history, and comparison appearances. Pro plan subscribers get additional data including visitor demographics, referral sources, and conversion benchmarks.',
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      {
        q: 'How do I report a tool or review that violates guidelines?',
        a: 'Every tool profile and review has a "Report" option. You can also contact our Trust & Safety team directly at trust@laudstack.com. We aim to respond to all reports within 48 hours and resolve serious violations within 5 business days.',
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        a: 'Click "Sign In" in the top navigation and choose to sign up with your Manus account or email. Account creation is free and takes less than a minute. You\'ll need an account to write reviews, upvote tools, save tools to your collection, and access personalised recommendations.',
      },
      {
        q: 'What data does LaudStack collect about me?',
        a: 'We collect the information you provide during registration (name, email), your activity on the platform (tools viewed, reviews written, upvotes cast), and standard analytics data (browser type, general location). We never sell your personal data to third parties. See our Privacy Policy for full details.',
      },
      {
      ...
      },
      {
        ...
        a: 'You can subscribe or unsubscribe from the LaudStack newsletter at any time via your Account Settings or by clicking the unsubscribe link at the bottom of any newsletter email. We send a weekly digest of top tools, trending picks, and platform updates — no spam.',
      },
      {
      ...
      <section style={{ background: '#FFFFFF', borderBottom: '1px solid #E2E8F0', padding: '56px 0 48px' }}>
        <div className="max-w-[1300px] mx-auto px-6 lg:px-10" style={{ textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 17, color: '#64748B', maxWidth: 520, margin: '0 auto 32px', lineHeight: 1.65 }}>
            Everything you need to know about LaudStack — from how reviews work to submitting your tool.
          </p>
        ...
        <div className="max-w-[1300px] mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-1 md:grid-cols-3" style={{ gap: 20 }}>
            {[
              ...
              {
                icon: Rocket, title: 'Submit Your Tool', desc: 'Founders can list their tool for free via LaunchPad.',
